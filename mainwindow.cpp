...
{
    this->ui->checkBox_1->setChecked(!this->ui->checkBox_1->isChecked());
    this->ui->checkBox_2->setChecked(!this->ui->checkBox_2->isChecked());
    this->ui->checkBox_3->setChecked(!this->ui->checkBox_3->isChecked());
    this->ui->checkBox_4->setChecked(!this->ui->checkBox_4->isChecked());
    this->ui->checkBox_5->setChecked(!this->ui->checkBox_5->isChecked());
    this->ui->checkBox_6->setChecked(!this->ui->checkBox_6->isChecked());
    this->ui->checkBox_7->setChecked(!this->ui->checkBox_7->isChecked());
    this->ui->checkBox_8->setChecked(!this->ui->checkBox_8->isChecked());
    this->ui->checkBox_9->setChecked(!this->ui->checkBox_9->isChecked());
    this->ui->checkBox_10->setChecked(!this->ui->checkBox_10->isChecked());
    this->ui->checkBox_11->setChecked(!this->ui->checkBox_11->isChecked());
    this->ui->checkBox_12->setChecked(!this->ui->checkBox_12->isChecked());
    this->ui->checkBox_13->setChecked(!this->ui->checkBox_13->isChecked());
    this->ui->checkBox_14->setChecked(!this->ui->checkBox_14->isChecked());
    this->ui->checkBox_15->setChecked(!this->ui->checkBox_15->isChecked());
    this->ui->checkBox_16->setChecked(!this->ui->checkBox_16->isChecked());
    this->ui->checkBox_17->setChecked(!this->ui->checkBox_17->isChecked());
    this->ui->checkBox_18->setChecked(!this->ui->checkBox_18->isChecked());
    this->ui->checkBox_19->setChecked(!this->ui->checkBox_19->isChecked());
    this->ui->checkBox_20->setChecked(!this->ui->checkBox_20->isChecked());
    this->ui->checkBox_21->setChecked(!this->ui->checkBox_21->isChecked());
    this->ui->checkBox_22->setChecked(!this->ui->checkBox_22->isChecked());
    this->ui->checkBox_23->setChecked(!this->ui->checkBox_23->isChecked());
    this->ui->checkBox_24->setChecked(!this->ui->checkBox_24->isChecked());
    this->ui->checkBox_25->setChecked(!this->ui->checkBox_25->isChecked());
    this->ui->checkBox_26->setChecked(!this->ui->checkBox_26->isChecked());
    this->ui->checkBox_27->setChecked(!this->ui->checkBox_27->isChecked());
    this->ui->checkBox_28->setChecked(!this->ui->checkBox_28->isChecked());
    this->ui->checkBox_29->setChecked(!this->ui->checkBox_29->isChecked());
    this->ui->checkBox_30->setChecked(!this->ui->checkBox_30->isChecked());
    this->ui->checkBox_31->setChecked(!this->ui->checkBox_31->isChecked());
}
